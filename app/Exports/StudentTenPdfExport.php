...
// SUBJECT NAMES ==========================================================
        ...
        if($this->previousClass){
            ...
            if($averages != []){
                $fieldMappings['GA1'] = round(array_sum($averages) / count($averages));
                // $fieldMappings['TA1'] = (array_sum($averages) / count($averages)) > 74 ? "Passed" : "Failed";
                if(array_sum($averages) / count($averages) == 0){
                    $fieldMappings['TA1'] = "";
                } else{
                    $fieldMappings['TA1'] = round((array_sum($averages) / count($averages))) > 74 ? "Passed" : "Failed";
                }
            }
            ...
            if($averages != []){
                $fieldMappings['GA2'] = round(array_sum($averages) / count($averages));
                // $fieldMappings['TA2'] = (array_sum($averages) / count($averages)) > 74 ? "Passed" : "Failed";
                if(array_sum($averages) / count($averages) == 0){
                    $fieldMappings['TA2'] = "";
                } else{
                    $fieldMappings['TA2'] = round((array_sum($averages) / count($averages))) > 74 ? "Passed" : "Failed";
                }
            }
            ...
            if($averages != []){
                $fieldMappings['GA3'] = round(array_sum($averages) / count($averages));
                // $fieldMappings['TA3'] = (array_sum($averages) / count($averages)) > 74 ? "Passed" : "Failed";
                if(array_sum($averages) / count($averages) == 0){
                    $fieldMappings['TA3'] = "";
                } else{
                    $fieldMappings['TA3'] = round((array_sum($averages) / count($averages))) > 74 ? "Passed" : "Failed";
                }
            }
            ...
            if($averages != []){
                $fieldMappings['GA4'] = round(array_sum($averages) / count($averages));
                // $fieldMappings['TA4'] = (array_sum($averages) / count($averages)) > 74 ? "Passed" : "Failed";
                if(array_sum($averages) / count($averages) == 0){
                    $fieldMappings['TA4'] = "";
                } else{
                    $fieldMappings['TA4'] = round((array_sum($averages) / count($averages))) > 74 ? "Passed" : "Failed";
                }
            }
        } else{
            $averages = [];
